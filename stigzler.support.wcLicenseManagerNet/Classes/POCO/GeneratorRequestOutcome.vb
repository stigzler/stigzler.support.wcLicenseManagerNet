...
''' </summary>
Public Class GeneratorRequestOutcome
    ''' <summary>
    ...
    ''' <summary>
    ''' Generated list of Generator objects. Can contain one or many.
    ''' </summary>
    Public Property Generators As New List(Of Generator)

    Public Overrides Function ToString() As String

        Dim retString As String = Nothing
        retString = "Process outcome: " & ProcessOutcome.ToString & " | API Success: " & APIReturnedSuccess.ToString & " | Generators count: " & Generators.Count
